...
static const char* funny_messages[][12] = {
	{"SCREW YOU GUYS", "IM GOING HOME", "I PUT MYSELF ON PSX MORTY", "IM PSX RIIIIIIIIIIIIIIICK", "CUCKYFNF", "AWARD WINNING SONIC NERD", "lool", "inverted colours", "NO FMV CUTSCENES", "SORRY", "USE A CONTROLLER", "LOL"},
