...
static const CharFrame char_bf_frame[] = {
	...
	{BF_ArcDead_Dead0, {  0,   0, 128, 128}, { 53,  98}}, //32 dead0 0
	{BF_ArcDead_Dead0, {128,   0, 128, 128}, { 53,  98}}, //33 dead0 1
	{BF_ArcDead_Dead0, {  0, 128, 128, 128}, { 53,  98}}, //34 dead0 2
	{BF_ArcDead_Dead0, {128, 128, 128, 128}, { 53,  98}}, //35 dead0 3

	{BF_ArcDead_Dead1, {  0,   0, 128, 128}, { 53,  98}}, //36 dead1 0
	{BF_ArcDead_Dead1, {128,   0, 128, 128}, { 53,  98}}, //37 dead1 1
	{BF_ArcDead_Dead1, {  0, 128, 128, 128}, { 53,  98}}, //38 dead1 2
	{BF_ArcDead_Dead1, {128, 128, 128, 128}, { 53,  98}}, //39 dead1 3

	{BF_ArcDead_Dead2, {  0,   0, 128, 128}, { 53,  98}}, //40 dead2 body twitch 0
	{BF_ArcDead_Dead2, {128,   0, 128, 128}, { 53,  98}}, //41 dead2 body twitch 1
	{BF_ArcDead_Dead2, {  0, 128, 128, 128}, { 53,  98}}, //42 dead2 balls twitch 0
	{BF_ArcDead_Dead2, {128, 128, 128, 128}, { 53,  98}}, //43 dead2 balls twitch 1
};
...
void Char_BF_Tick(Character *character)
{
	...
	if (stage.stage_id == StageId_1_2 && stage.song_step >= 2158)
	{
		...
		this->character.focus_zoom = FIXED_DEC(6, 10);
	}


	if (stage.stage_id == StageId_1_2 && stage.song_step >= 2162)
	{
...
Character *Char_BF_New(fixed_t x, fixed_t y)
{
	...
	{
		//Load "Ugh" art
		this->arc_scene = IO_Read("\\CHAR\\BFUGH.ARC;1");
		
		const char** pathp = (const char* []){
			"ugh0.tim", //BF_ArcScene_0
			"ugh1.tim", //BF_ArcScene_1
			NULL
		};
		IO_Data* arc_ptr = &this->arc_ptr[BF_ArcScene_0];
		for (; *pathp != NULL; pathp++)
