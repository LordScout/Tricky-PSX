...
static const CharFrame char_tank_frame[] = {
	{Tank_ArcMain_Idle0, {  0,   0, 152, 154}, { 74, 143}}, //0 idle 1
	{Tank_ArcMain_Idle1, {  0,   0, 153, 152}, { 73, 141}}, //1 idle 2
	{Tank_ArcMain_Idle2, {  0,   0, 155, 160}, { 75, 150}}, //2 idle 3
	{Tank_ArcMain_Idle3, {  0,   0, 154, 163}, { 72, 153}}, //3 idle 4
	{Tank_ArcMain_Idle4, {  0,   0, 155, 161}, { 75, 151}}, //4 idle 2
	{Tank_ArcMain_Idle5, {  0,   0, 155, 164}, { 74, 154}}, //5 idle 3
	{Tank_ArcMain_Idle6, {  0,   0, 154, 162}, { 72, 152}}, //6 idle 4
	
	{Tank_ArcMain_Left0, {  0,   0, 202, 169}, { 120, 158}}, //7 left 1
	{Tank_ArcMain_Left1, {  0,   0, 198, 169}, { 120, 158}}, //8 left 1
	{Tank_ArcMain_Left2, {  0,   0, 188, 173}, { 114, 162}}, //9 left 1
	{Tank_ArcMain_Left3, {  0,   0, 190, 169}, { 115, 159}}, //10 left 1
	{Tank_ArcMain_Left4, {  0,   0, 192, 171}, { 119, 160}}, //11 left 1
	{Tank_ArcMain_Left5, {  0,   0, 187, 170}, { 115, 159}}, //12 left 1
	{Tank_ArcMain_Left6, {  0,   0, 188, 173}, { 115, 162}}, //13 left 1
	
	{Tank_ArcMain_Down0, {  0,   0, 185, 149}, { 84, 138}}, //14 down 1
	{Tank_ArcMain_Down1, {  0,   0, 182, 150}, { 83, 138}}, //15 down 2
	{Tank_ArcMain_Down2, {  0,   0, 183, 153}, { 79, 142}}, //16 down 1
	{Tank_ArcMain_Down3, {  0,   0, 180, 152}, { 78, 140}}, //17 down 2
	{Tank_ArcMain_Down4, {  0,   0, 181, 154}, { 80, 142}}, //18 down 1
	{Tank_ArcMain_Down5, {  0,   0, 180, 153}, { 77, 142}}, //19 down 1
	
	{Tank_ArcMain_Up0, {  0,   0, 147, 169}, { 87, 160}}, //20 up 1
	{Tank_ArcMain_Up1, {  0,   0, 147, 166}, { 90, 157}}, //21 up 2
	{Tank_ArcMain_Up2, {  0,   0, 145, 169}, { 93, 159}}, //22 up 1
	{Tank_ArcMain_Up3, {  0,   0, 145, 165}, { 92, 155}}, //23 up 2
	{Tank_ArcMain_Up4, {  0,   0, 145, 167}, { 94, 157}}, //24 up 1
	{Tank_ArcMain_Up5, {  0,   0, 149, 167}, { 95, 157}}, //25 up 2
	{Tank_ArcMain_Up6, {  0,   0, 144, 170}, { 92, 160}}, //26 up 2
	
	{Tank_ArcMain_Right0, {  0,   0, 233, 142}, { 82, 132}}, //27 right 1
	{Tank_ArcMain_Right1, {  0,   0, 219, 146}, { 74, 136}}, //28 right 2
	{Tank_ArcMain_Right2, {  0,   0, 219, 147}, { 74, 138}}, //29 right 1
	{Tank_ArcMain_Right3, {  0,   0, 216, 147}, { 71, 138}}, //30 right 2
	{Tank_ArcMain_Right4, {  0,   0, 218, 146}, { 74, 137}}, //31 right 1
	{Tank_ArcMain_Right5, {  0,   0, 218, 147}, { 73, 137}}, //32 right 2
	{Tank_ArcMain_Right6, {  0,   0, 219, 148}, { 75, 139}}, //33 right 2
	
	{Tank_ArcScene_0, {  0,   0, 128, 256}, { 48, 125}}, //35 ugh 0
	{Tank_ArcScene_0, {128,   0, 128, 256}, { 50, 128}}, //36 ugh 1
	{Tank_ArcScene_1, {  0,   0, 128, 256}, { 49, 128}}, //37 ugh 2
	{Tank_ArcScene_1, {128,   0, 128, 256}, { 49, 128}}, //38 ugh 3
...
Character *Char_Tank_New(fixed_t x, fixed_t y)
{
	...
	const char **pathp = (const char *[]){
		...
		"idle4.tim", //Tank_ArcMain_Idle0
		"idle5.tim", //Tank_ArcMain_Idle1
		"idle6.tim", //Tank_ArcMain_Idle1
		"left0.tim",  //Tank_ArcMain_Left
		"left1.tim",  //Tank_ArcMain_Left
		"left2.tim",  //Tank_ArcMain_Left
		"left3.tim",  //Tank_ArcMain_Left
		"left4.tim",  //Tank_ArcMain_Left
		"left5.tim",  //Tank_ArcMain_Left
		"left6.tim",  //Tank_ArcMain_Left
		"down0.tim",  //Tank_ArcMain_Down
		"down1.tim",  //Tank_ArcMain_Down
		"down2.tim",  //Tank_ArcMain_Down
		"down3.tim",  //Tank_ArcMain_Down
		"down4.tim",  //Tank_ArcMain_Down
		"down5.tim",  //Tank_ArcMain_Down
		"up0.tim",    //Tank_ArcMain_Up
		"up1.tim",    //Tank_ArcMain_Up
		"up2.tim",    //Tank_ArcMain_Up
		"up3.tim",    //Tank_ArcMain_Up
		"up4.tim",    //Tank_ArcMain_Up
		"up5.tim",    //Tank_ArcMain_Up
		"up6.tim",    //Tank_ArcMain_Up
		"right0.tim", //Tank_ArcMain_Right
		"right1.tim", //Tank_ArcMain_Right
		"right2.tim", //Tank_ArcMain_Right
		"right3.tim", //Tank_ArcMain_Right
		"right4.tim", //Tank_ArcMain_Right
		"right5.tim", //Tank_ArcMain_Right
		"right6.tim", //Tank_ArcMain_Right
		NULL
	};
